...
<head>
    ...
    <title>InternetShop @yield('title')</title>
</head>
<body>
<header>
                ...
                <ul class="navbar-nav">
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-dark">
                            ...
                            <li><a class="dropdown-item" href="/basket">В корзину</a></li>
                            <li><a class="dropdown-item" href="/">Сбросить проект в начальное состояние</a></li>
